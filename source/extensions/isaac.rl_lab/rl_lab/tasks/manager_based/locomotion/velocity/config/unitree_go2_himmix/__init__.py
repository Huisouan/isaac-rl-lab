...
gym.register(
    id="Isaac-Himmix-Unitree-go2-v0",
    entry_point="rl_lab.tasks.manager_based.locomotion.velocity.config.unitree_go2_himmix.env.manager_based_rl_amp_env:ManagerBasedRLAmpEnv",
...
gym.register(
    id="Isaac-Rough-Himmix-Unitree-go2-v0",
    entry_point="rl_lab.tasks.manager_based.locomotion.velocity.config.unitree_go2_himmix.env.manager_based_rl_amp_env:ManagerBasedRLAmpEnv",
    disable_env_checker=True,
    kwargs={
